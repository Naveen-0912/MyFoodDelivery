...
class NewOrderViewModelFactory(private val databaseProvider: DatabaseProvider,
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return NewOrderViewModel(databaseProvider, cartDataStoreHelper, loggedInAccountDataStoreHelper) as T
    }
}